<tr>
        ...
        <td>
            ...
            <button type="submit" name="removeDue" type="button" class="btn bg-primary bg-gradient text-white shadow" value="<?= $item->reserve_id ?>">Remove</button>
        </td>
</tr>

<?php include(views_path("list-tab/reserve-tab/reserve-modal/overdue-reserve-modal")); ?>