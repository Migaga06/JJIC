<div class="container-fluid  p-4 shadow-5 mx-auto" style = "max-width: 1000px; background-color: rgb(45, 45, 45);">
    ...
    <h4 class=" text-center mb-5" style="color: rgb(102, 102, 255);"><i class="fa"><i class="fa fa-circle-question"></i> Are you sure you want to reserve this item?</i></h4>
    
    <?php if($row_cart){ ?>
      
    <div class="row mx-2 p-3 shadow-lg rounded-4 border-top border-bottom border-secondary" style="background-color: rgba(102, 102, 255, 0.7);">
      <div class="col-sm-12 col-md-5 col-lg-4">
        <img src="<?=ROOT?>/<?= $row_cart[0]->image ?>" alt="" class="d-block border border-warning mx-auto rounded-4" style="width: 100%; height: 100%;">
      </div>
      <div class="col-sm-12 col-md-7 col-lg-8 mt-3 mb-3">
        <h3 class="card-title p-2 border border-white rounded-4 mx-1 my-1 text-white shadow" style = "background-color: rgba(75, 75, 75, 0.8);">
          <i class="fa fa-product-hunt"></i> <?= $row_cart[0]->product_name ?>
        </h3>
        <h5 class="card-title p-2 border border-white rounded-4 mt-2 mx-1 text-white shadow" style = "background-color: rgba(75, 75, 75, 0.8);">
          <i class="fa fa-message"></i></i> <?= $row_cart[0]->product_description ?>
        </h5>
        <!--form-->
          ...
          <div class="row mt-3 ">
            <div class="col-4">
              <p class="card-text text-success px-2 border border-success rounded-5 shadow" style = "background-color: rgba(255, 255, 255, 0.9);">
                <small>
                  <small>
                    <i class="fa fa-peso-sign"></i> <?= $row_cart[0]->product_price ?>
                  </small>
                </small>
              </p>
            </div>
            <div class="col-4">
              <p class="card-text text-primary px-2 border border-primary rounded-5 shadow" style = "background-color: rgba(255, 255, 255, 0.9);">
                <small>
                  <small>
                    <i class="fa fa-boxes-stacked"></i> <?= $row_cart[0]->product_qty ?>
                  </small>
                </small>
              </p>
            </div>
            <div class="col-4">
              <p class="card-text text-danger px-2 border border-danger rounded-5 shadow" style = "background-color: rgba(255, 255, 255, 0.9);">
                <small>
                  <small>
                    <i class="fa fa-t"></i> <?= $row_cart[0]->product_type ?>
                  </small>
                </small>
              </p>
            </div>
    ...
    <?php }else{ ?>
      <div class="container-fluid rounded-2 bg-dark p-2" style = "background-color: rgba(255, 51, 51, 1);">
        <h3 class = "text-white text-center">Syntax Error</h3>
      </div>
    <?php } ?>
</div>
<script>
