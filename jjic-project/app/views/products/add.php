<?php include PATH . "partials/header.php" ?>
  ...
  <!--for later--><?php include PATH . "partials/crumbs.php" ?>
    <h2 class="text-white text-center mb-5"><i class="fa">Add to Cart</i></h2>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <a href="<?= ROOT ?>/products/add/<?= $row[0]->product_id ?>" class="btn btn-close">
                            ...
                            <div class="modal-footer">
                                <a href="<?= ROOT ?>/products/add/<?= $row[0]->product_id ?>" class= "btn btn-danger ">
          ...
          <div class="row mt-3">
            ...
            <div class="row">
              <div class="col-12 text-center text-md-end text-lg-end mt-2">
                ...
                <button type="submit" class="btn bg-black bg-gradient text-white shadow">Add to Cart</button>
              </div>
            </div>
        </form>
      </div>
