...
<script>
    ...
    <div class="container-fluid  p-4 shadow-5 mx-auto" style = "max-width: 1000px; background-color: rgb(45, 45, 45);">
        ...
        <h1 class="text-white"><i class="fa">Delete Profile Account</i></h1>
        ...
        <h5 class="text-white text-center">Are you sure you want to delete?!</h5>
            ...
            <input type="hidden" name="id" value="<?= $row[0]->user_id ?>">
            <div class="col-sm-8 col-md-9 p-2 mt-1">
                <table class="table table-dark table-hover table-striped table-bordered">
                    <tr>
                        <th>Role:</th>
                        <td>
                            <select disabled autofocus name="role" class="form-control">
                    ...
                    <tr>
                        <th>First Name:</th>
                        <td>
                            <input disabled autofocus name="firstname" value="<?= $row[0]->firstname ?>" type="text" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <th>Last Name:</th><td>
                            <input disabled autofocus name="lastname" value="<?= $row[0]->lastname ?>" type="text" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <th>Email:</th>
                        <td>
                            <input disabled autofocus name="email" value="<?= $row[0]->email ?>" type="email" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <th>Password:</th>
                        <td>
                            <input disabled autofocus name="password" value="<?= $row[0]->password ?>" type="password" class="form-control">
                        </td>
                    </tr>
                </table>
            </div>
            <div class="container">
                <div class="row">
                <button type="submit" class="btn bg-black bg-gradient text-white">Delete</button>
